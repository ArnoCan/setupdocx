...
The *Makefile* implements a execution wrapper wrapper for the creation of the documents.
Similar to *Makefile*.
...
.. only:: not builder_man
   ...
   .. literalincludewrap:: _static/Makefile_docx
      :language: make
      :linenos:
   ...
   .. only:: builder_html
      ...
      `Makefile_docx <_static/Makefile_docx>`_
