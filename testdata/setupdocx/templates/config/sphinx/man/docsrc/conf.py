...
man_pages = [
    ...
    ('call_doc', 'call_doc.sh', 'wrapper for document creation', 'Arno-Can Uestuensoez', 3),
    ('call_apidoc', 'call_apidoc.sh', 'wrapper for API generator', 'Arno-Can Uestuensoez', 3),
    ('call_apiref', 'call_apiref.sh', 'wrapper for API reference generator', 'Arno-Can Uestuensoez', 3),
