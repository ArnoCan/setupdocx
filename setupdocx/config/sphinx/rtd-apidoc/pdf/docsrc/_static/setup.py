...
_keywords = ''
_keywords += ' sphinx sphinx-build sphinx-apidoc '
_keywords += ' epydoc '
_keywords += ' documentation doc docx build_docx '
_keywords += ' setuptools distutils setup.py setup extension "setup extension"'

_keywords += ' CPython IPython IronPython Jython PyPy '
_keywords += ' Java "Java Scripting"'
_keywords += ' Python2 Python3 '
_keywords += ' bitmask bitarray hexvalue '
...
_keywords += ' ArchLinux BlackArchLinux BlackArch Arch ArchLinuxARM ARM '
